...
<div class="panel">
    <div class="panel-body">
        <form class="form-horizontal" role="form" id="form" action="act.php" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="name" class="col-sm-1 col-md-1 col-lg-1 control-label">商品价格（浙江）</label>
                <div class="col-sm-3 col-md-3 col-lg-3">
                    <input type="text" class="form-control" id="price" name="price" placeholder="请输入商品价格">
                </div>
            </div>
            <div class="form-group">
                <label for="name" class="col-sm-1 col-md-1 col-lg-1 control-label">商品价格2(浙江以外)</label>
                <div class="col-sm-3 col-md-3 col-lg-3">
                    <input type="text" class="form-control" id="price2" name="price2" placeholder="请输入商品价格">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-3 col-md-3 col-lg-3">
                    <textarea class="form-control" placeholder="请输入商品描述" name="desc"></textarea>
                </div>
            </div>
            <div class="form-group">
